    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_order', models.PositiveIntegerField(default=0)),
                ('mode', django_intenum.IntEnumField(choices=[(1, 'NORMAL'), (2, 'EXPERT'), (3, 'HEROIC'), (4, 'CLASS_CHALLENGE')], default=0, validators=[django_intenum.IntEnumValidator(hsreplaynet.scenarios.models.AdventureMode)])),
